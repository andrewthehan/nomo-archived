...
abstract class MutableVector2<NumberType : Number, VectorType: MutableVector<NumberType, *>>(x: NumberType = zero<NumberType>(), y: NumberType = zero<NumberType>()) : AbstractMutableVector<NumberType, VectorType>(x, y) {
  var x: NumberType
    get() = this[0]
